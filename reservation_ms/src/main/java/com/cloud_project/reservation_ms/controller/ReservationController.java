...
public class ReservationController {
    ...
    @GetMapping("/{email}")
    public ResponseEntity<List<ReservationWithExamDto>> getReservationsByEmail(@PathVariable String email) {
        List<ReservationWithExamDto> reservationsList = reservationService.getReservationsByEmail(email);
